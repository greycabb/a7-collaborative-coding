...
All students put together had visited a total of `r sl$total_countries_visited` (not exclusive); each student has visited an average of `r sl$average_countries_visited` countries.
